...
function Components() {
    ...
    return (
        <div>
            <button className="btn" defaultSelectedKeys={['#1']} style={{ backgroundColor: '#1d1dc1', color: 'white', width: "100px", height: '30px' }} id="button-1" onClick={btnClick} draggable="true" onDragStart={(e) => dragStart(e)} onDrag={drag} onDragEnd={dragEnd}>button</button>
            ...
            {/* <div className="component-wrapper" style={{ backgroundColor: '#f9f9f9', border: '1px solid #00000008', borderRadius: '5px', marginTop: '1rem', padding: '.5rem' }} >
                <p id="text-1" onClick={(e) => e.stopPropagation()} draggable="true" onDragStart={(e) => dragStart(e)} onDrag={drag} onDragEnd={dragEnd}>
                   hiiii, welcome to the page builder welcome to the page builder</p>
            </div> */}
