...
export default function Button() {
    ...
    return (
        <div>
            <button className="btn" style={{ backgroundColor: '#1d1dc1', color: 'white', width: "200px", height: '80px',resize:'both', overflow:"auto" }} id="button-1" onClick={btnClick} draggable="true" onDragStart={(e) => dragStart(e)} onDrag={drag} onDragEnd={dragEnd}>button</button>
