...
const items = [
  getItem("Design", "1", <AppstoreOutlined />, [
    getItem(
      ...
      "g1",
      null,
      [getItem("Option 1", "6"), getItem("Option 2", "7")],
      "group"
    ),
    getItem(
      "Layout Elements",
      "g2",
      null,
      [getItem("Option 3", "8"), getItem("Option 4", "9")],
      "group"
    ),
    getItem(
      "Selection Elements",
      ...
      <Layout className="site-layout">
        <Header>
          <Row gutter={16} justify="space-around">
            ...
            <Col>
              <div>
                <Button type="primary" title="preview" icon={<EyeOutlined />}>
                  {" "}
                </Button>
              </div>
            </Col>
            ...
            <Col>
              <div>
                <Button type="primary" title="save" icon={<SaveOutlined />}>
                  Save{" "}
                </Button>
              </div>
            </Col>
